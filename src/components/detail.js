...
export default function Detail({ movie, directorList }) {
  ...
  return (
    <div className="-mb-8 sm:mb-0 px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24">
      <div className="flex flex-col sm:flex-row items-center mx-auto max-w-8xl">
        <div className="w-full max-w-2xl">
          {/* Movie Poster with Fallback Image */}
          {movie?.poster_path ? (
            <Image
              className="object-cover max-h-screen object-center mx-auto rounded-lg shadow-2xl"
        ...
        <div className="text-white pl-0 w-fit sm:pl-4 md:pl-8 pt-6 pb-4 space-y-2 max-w-md">
          <h1 className="underline decoration-rose-500 underline-offset-8 text-cyan-500 md:text-2xl lg:text-3xl font-bold">
            Title
          </h1>
          <p className="text-cyan-100 sm:text-sm md:text-md lg:text-lg text-left">
            {movie?.title}
          </p>
          <h1 className="underline decoration-rose-500 underline-offset-8 text-cyan-500 md:text-2xl lg:text-3xl font-bold">
            Overview
